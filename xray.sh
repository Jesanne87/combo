...
wget -q -O /usr/local/etc/xray/config.json https://raw.githubusercontent.com/Jesanne87/Version/main/config.json
wget -q -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/Jesanne87/Version/main/nginx.conf
wget -q -O /etc/nginx/conf.d/xray.conf https://raw.githubusercontent.com/Jesanne87/Version/main/xray.conf
systemctl restart nginx
